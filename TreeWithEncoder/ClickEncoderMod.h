...
#ifndef __have__ClickEncoderMod_h__
#define __have__ClickEncoderMod_h__
...
public:
  ClickEncoderMod(uint8_t A, uint8_t B, uint8_t BTN = -1, 
...
#endif // __have__ClickEncoderMod_h__
